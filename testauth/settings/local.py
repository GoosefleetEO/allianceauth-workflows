...
# to https://onboarding.com/sso/callback
# substituting your domain for onboarding.com
...
ESI_USER_CONTACT_EMAIL = "dummy@onboarding.net"
...
# Set the default from email to something like 'noreply@onboarding.com'
