    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "body",
                    models.TextField(
                        blank=True, help_text="Body text (django template snippet)"
                    ),
                ),
                (
                    "is_selfguided",
                    models.BooleanField(
                        default=False,
                        help_text="Overrides any Smart Filters assigned to this step.",
                    ),
                ),
                (
                    "checks",
                    sortedm2m.fields.SortedManyToManyField(
                        blank=True, help_text=None, to="workflows.check"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "permalink",
                    models.SlugField(
                        blank=True, help_text="user friendly permalink slug", null=True
                    ),
                ),
                (
                    "body",
                    models.TextField(
                        blank=True,
                        help_text="Body text for final page (django template snippet)",
                    ),
                ),
                (
                    "auto_assigned",
                ...
                (
                    "steps",
                    sortedm2m.fields.SortedManyToManyField(
                        help_text=None, to="workflows.step"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "step",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="workflows.step"
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="workflows.checkfilter"
            ),
        ),
        migrations.CreateModel(
            name="ActionItem",
